...
export const TAG_COLORS = {
  yellow: {
    ...
    pillActive:
      'bg-yellow-200 text-yellow-900 ring-2 ring-yellow-400 dark:bg-yellow-500/30 dark:text-yellow-100 dark:ring-yellow-400',
  ...
  green: {
    ...
    pillActive:
      'bg-green-200 text-green-900 ring-2 ring-green-400 dark:bg-green-500/30 dark:text-green-100 dark:ring-green-400',
    glow: 'tag-glow-green',
    dot: 'bg-green-500',
  },
  red: {
    ...
    pillActive:
      'bg-red-200 text-red-900 ring-2 ring-red-400 dark:bg-red-500/30 dark:text-red-100 dark:ring-red-400',
    glow: 'tag-glow-red',
    dot: 'bg-red-500',
  },
  blue: {
    ...
    pillActive:
      'bg-blue-200 text-blue-900 ring-2 ring-blue-400 dark:bg-blue-500/30 dark:text-blue-100 dark:ring-blue-400',
    glow: 'tag-glow-blue',
    dot: 'bg-blue-500',
  },
  purple: {
    ...
    pillActive:
      'bg-purple-200 text-purple-900 ring-2 ring-purple-400 dark:bg-purple-500/30 dark:text-purple-100 dark:ring-purple-400',
  ...
  orange: {
    ...
    pillActive:
      'bg-orange-200 text-orange-900 ring-2 ring-orange-400 dark:bg-orange-500/30 dark:text-orange-100 dark:ring-orange-400',
  ...
  pink: {
    ...
    pillActive:
      'bg-pink-200 text-pink-900 ring-2 ring-pink-400 dark:bg-pink-500/30 dark:text-pink-100 dark:ring-pink-400',
    glow: 'tag-glow-pink',
    dot: 'bg-pink-500',
  },
  cyan: {
    ...
    pillActive:
      'bg-cyan-200 text-cyan-900 ring-2 ring-cyan-400 dark:bg-cyan-500/30 dark:text-cyan-100 dark:ring-cyan-400',
    glow: 'tag-glow-cyan',
    dot: 'bg-cyan-500',
  },
};
